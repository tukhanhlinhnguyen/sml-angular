...
@Component({
  selector: 'app-shop-list-rs',
  templateUrl: './shop-list-rs.component.html',
  styleUrls: ['./shop-list-rs.component.scss']
})

/**
 * Shop List Right Sidebar Component
 */
export class ShopListRsComponent implements OnInit {
 ...
 ngOnInit(): void {
  document.querySelector('.list-rs')?.classList.add('offcanvas-end');
