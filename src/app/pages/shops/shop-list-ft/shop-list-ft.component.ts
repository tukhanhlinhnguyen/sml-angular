...
@Component({
  selector: 'app-shop-list-ft',
  templateUrl: './shop-list-ft.component.html',
  styleUrls: ['./shop-list-ft.component.scss']
})

/**
 * Shop List Filter On Top Component
 */
export class ShopListFtComponent implements OnInit {
