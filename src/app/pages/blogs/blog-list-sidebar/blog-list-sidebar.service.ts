...
import { SortDirection, SortColumn } from './blog-list-sidebar-sortable.directive';
...
function matches(table: Table, term: string, pipe: PipeTransform) {
    return table.title.toLowerCase().includes(term.toLowerCase());
}
...
export class BlogSidebarListService {
