...
@Component({
  selector: 'app-navbar-level2-light',
  templateUrl: './navbar-level2-light.component.html',
  styleUrls: ['./navbar-level2-light.component.scss']
})

/**
 * Navbar-Level2-Light Component
 */
export class NavbarLevel2LightComponent implements OnInit {
